...
<body>
	<div id="page-container">
		...
		<spf:form action="${path}/update" method="post" modelAttribute="ncc">
			<table border="1">
				<tr>
					<th>Tên nhà cung cấp</th>
					<td><spf:input path="id" readonly="true" /></td>
				</tr>
				<tr>
					<th>Tên nhà cung cấp</th>
				...
				<tr>
					<th>Ngày tạo</th>
					<td><spf:input path="gay_tao" type="date" readonly="true" />

					</td>
				</tr>
				<tr>
					<th>Ngày cập nhật</th>
					<td><spf:input path="ngay_cap_nhat" type="date"
							readonly="true" /></td>
				</tr>
				<tr>
					<th>Mã số thuế</th>
