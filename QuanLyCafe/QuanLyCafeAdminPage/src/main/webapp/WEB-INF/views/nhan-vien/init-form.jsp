...
<body>
	<div id="page-container">
		...
		<a class="link" href="${rootpath}">Trang chủ</a>|| <a class="link"
			href="${path}">Quản lý nhân viên</a>

		<spf:form action="${path}/insert" method="post" modelAttribute="nv">
			...
			<table border="1">
				...
				<tr>
					<th>Phân quyền</th>
					<td><spf:select path="phanquyen.id">
							<spf:options items="${lstpq}" itemLabel="ten_quyen"
								itemValue="id" />
						</spf:select></td>
				</tr>
				<tr>
