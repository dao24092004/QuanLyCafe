...
<body>
	<div id="page-container">
		...
		<a class="link" href="${rootpath}">Trang chủ</a>|| <a class="link"
			href="${rootpath}khach-hang">Trang khách hàng</a>|| <a class="link"
			href="${rootpath}/hang-hoa/cart">Giỏ hàng</a> <b style="color: red;">${msg}</b>
		<spf:form action="${path}/update" method="post" modelAttribute="nv">
			...
			<table border="1">
				...
				<tr>
					<th>ID Phân quyền</th>
					<td><spf:input path="id_phan_quyen" type="number"
							readonly="true" /> <spf:errors cssClass="box-err"
							path="id_phan_quyen" /></td>
				</tr>
				<tr>
					<th>Lương cơ bản</th>
					<td><spf:input path="luong_co_ban" type="number"
							readonly="true" /></td>
				</tr>
				<tr>
					<th>UserName</th>
